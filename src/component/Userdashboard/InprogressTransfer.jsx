...
const [transactionPendingData, setTransactionPendingData] = useState([]);
...
/**************************************************************************
  ...
  console.log(transactionPendingData," nnkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk")
    ...
    return(
        ...
        { transactionPendingData?.length != 0 ? (
          <Table className="table table-responsive-md card-table previous-transaction">
              ...
              <tbody>
              {
                  transactionPendingData.data?.map((res, index) => {
                  //console.log(items, "itemnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn")
                  return(
                    <tr>
                    <td>{res.date}</td>
                    <td>{res.recieve_amount}<span>{res.recieve_currency}</span>
                    </td>
                                ...
                                <span>SENT- {summeryData.date}</span>                                                                              
                                  ...
                                  <div className="my-auto transac-text">
                                      ...
                                      <span className="fs-6 pt-1 fw-bold statuspopup">Status</span>
                                        <span className="fs-6 pt-1 fw-bold statuspopup">{PendingStatusData}</span>
                                        <hr></hr>
