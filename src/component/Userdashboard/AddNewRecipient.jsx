  ...
  return (
    <section className="showrecepient">
      <div class="form-head mb-4">
        <h2 class="text-black font-w600 mb-0"><b>{id?"Update":"Add" } Recipient</b>
...
//         .min(3, 'Minimum 3 symbols')
//         .max(50, 'Maximum 50 symbols')
//         .required('Email is required').trim().notOneOf([""]),
//       other_name: Yup.string().min(3).max(50).test("value-test", (value, validationcontext) => {
//         const {
//           createError,
//           parent: {
...
//       mobile: Yup.string().min(11).max(18).required(),
//       flat: Yup.string().min(1).max(30).notRequired().trim(),
//       building: Yup.string().min(1).max(30).required().trim(),
//       street: Yup.string().min(1).max(900).required().trim(),
//       city: Yup.string().min(1).max(35).required().trim(),
//       post_code: Yup.string().length(5).notRequired(),
//       state: Yup.string().min(1).max(35).required().trim(),
//       country: Yup.string().min(2).max(30).required().trim()
//     }),
//     onSubmit: async (values) => {
//       setLoading(true)
//       let d = values
...
//                     className={clsx(
//                       'form-control bg-transparent',
//                       { 'is-invalid': formik.touched.email && formik.errors.email && formik.values.email },
//                       {
...
//                   <PhoneInput
//                     onlyCountries={["au", "gh", "ke", "ng", "nz", "ph", "th", "vn"]}
//                     country={formik.values.country_code ? formik.values.country_code.toLowerCase() : "au"}
//                     name="mobile"
//                     value={formik.values.mobile}
//                     inputStyle={{ border: "none", margin: "none" }}
//                     inputClass="userPhone w-100"
...
// email: "", mobile: "", flat: "",
// building: "", street: "", city: "",
// postcode: "", state: "", country: "",country_code: "AU"
//   }
