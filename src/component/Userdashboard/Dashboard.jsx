                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="dashbord-user dCard-1">
                                    <div className="dashboard-content">
                                        ...
                                        <div className="mt-3">
                                            <NavLink to="/dashboard/recipients" className="btn btn-outline-dark btn-rounded">
                                                View
                                            </NavLink>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="dashbord-user dCard-1 middle-card">
                                    <div className="dashboard-content">
                                        ...
                                        <div className="mt-3">
                                            <NavLink to="/dashboard/new-transfer" className="btn btn-outline-dark btn-rounded">
                                                Send Money
                                            </NavLink>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="dashbord-user dCard-1">
                                    <div className="dashboard-content">
                                        ...
                                        <div className="mt-3">
                                            <NavLink to="/dashboard/profile" className="btn btn-outline-dark btn-rounded">
                                                View
                                            </NavLink>
